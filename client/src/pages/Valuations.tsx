        ...
        <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <section className="bg-brand-gradient py-24 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    >
                        <Link href="/checkout?service=valuations">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {pricingOptions.map((opt, i) => (
                        ...
                        >
                            ...
                            <Link href={`/checkout?service=valuations&variant=${opt.variant}`}>
            ...
            <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {situations.map((sit, i) => (
                        <Link key={i} href={sit.link || `/checkout?service=valuations&case=${sit.case}`}>
